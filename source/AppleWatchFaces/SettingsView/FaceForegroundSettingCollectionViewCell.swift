    ...
    func redrawScene() {
        if let scene = skView.scene {
            ...
            if !self.isSelected {
                ...
                let handNode = FaceForegroundNode.init(foregroundType: faceForegroundType, material: "#ddddddff", material2: "#ddddddff", strokeColor: SKColor.clear, lineWidth: 1.0, shapeType: .Circle, itemSize: 8.0)
                ...
                let selectedHandNode = FaceForegroundNode.init(foregroundType: faceForegroundType, material: "#ddddddff", material2: "#ddddddff", strokeColor: strokeColor, lineWidth: highlightLineWidth, shapeType: .Circle, itemSize: 8.0)
