    ...
    func redrawScene() {
        if let scene = skView.scene {
            ...
            if !self.isSelected {
                ...
                let handNode = FaceForegroundNode.init(foregroundType: faceForegroundType, material: "#ddddddff", material2: "", strokeColor: SKColor.clear, lineWidth: 1.0)
                ...
                let selectedHandNode = FaceForegroundNode.init(foregroundType: faceForegroundType, material: "#ddddddff", material2: "", strokeColor: strokeColor, lineWidth: highlightLineWidth)
