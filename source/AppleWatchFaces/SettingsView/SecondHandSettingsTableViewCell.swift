...
class SecondHandSettingsTableViewCell: WatchSettingsSelectableTableViewCell, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let scene = cell.skView.scene {
            ...
            let selectedHandNode = SecondHandNode.init(secondHandType: cell.secondHandType, material: "#ff0000ff", strokeColor: highlightColor, lineWidth:highlightLineWidth, glowWidth: 0, fieldType: .None)
